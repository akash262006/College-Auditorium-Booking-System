...
public class StudentLoginGUI extends JFrame {
    ...
    public StudentLoginGUI() {
        ...
        // Buttons Panel
        JPanel btnPanel = new JPanel(new GridLayout(3, 1, 10, 10)); // 3 rows, 1 col
        ...
        ModernTheme.applymodernButton(registerBtn, ModernTheme.ACCENT_COLOR);
    ...
    private void studentLogin() {
        try {
            ...
            if (rs.next()) {
                ...
                new StudentDashboardGUI(userId);
                dispose();
            } else {
